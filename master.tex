...
\begin{minipage}[t][][t]{.65\linewidth}
  ...
  \begin{cvpart}{Extracurricular Activities}
    ...
    \devskills{Teamworking, Communication, Python, Arduino}
    ...
    \devskills{Teamworking, Communication, Management, Windows}
  \end{cvpart}
  ...
  \begin{cvpart}{Notable Projects}
    ...
    \devskills{Python, \emph{SQL}, Linux, Rasperry Pi, \LaTeX2}
