...
\topinfo{
  Recent graduate interested in \emph{Data Science}/\emph{Machine Learning}. Highly motivated, very quick learner and extremely self-taught. Always eager to learn and improve, both personally and professionally. 
}                        % Name and stuff
...
\begin{minipage}[t][][t]{.65\linewidth}
  ...
  \begin{cvpart}{Extracurricular Activities}
    ...
    \devskills{Team-work, Communication, Event Management/Organization }
