...
\topinfo{
  Recent graduate interested in \emph{Data Science}/\emph{Machine Learning} jobs. Highly motivated, very quick learner and extremely self-taught. Always eager to learn and improve, both personally and professionally. Very friendly personality.
}                        % Name and stuff
...
\begin{minipage}[t][][t]{.65\linewidth}
  ...
  \begin{cvpart}{Extracurricular Activities}
    ...
    \devskills{Team-working, Communication, Python, Arduino}
    ...
    \devskills{Team-working, Communication, Management, Windows,\\ Networking}
  \end{cvpart}
